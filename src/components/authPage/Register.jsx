            ...
            >
                ...
                >
                    ...
                    <div className="absolute left-9 right-9 z-10" style={{ top: "35%", transform: "translateY(-75%)" }}>
                        ...
                        >
                            400K+ users. 50M+ AI{" "}
                            <span className="text-white/45">generated graphics.</span>
                        </h2>
                        <button
                ...
                <div className="flex flex-col justify-center p-10 px-30 font-dm " >
                    ...
                    <p className="text-xs text-white/30 mb-7">Register to continue to NexStep.</p>
                    ...
                    <p className="text-center text-xs text-white/30 mt-5">
                        ...
                        <Link to={'/login'} className="text-white/60 underline underline-offset-2 hover:text-violet-400 transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
